...
class ProductControllerTest{
    ...
    fun createProduct() {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/products/new")
            /* 자바스크립트 JSON.Stringify( {object} ) 와 같음 . 객체를 string 으로 변환 */
    ...
    @Test
    fun createProductWithoutSellingStatus() {
        /* given */
        val productCreateRequest = ProductCreateRequest(
            type = ProductType.HANDMADE,
            sellingStatus = null,
    ...
    @Test
    fun createProductWithoutNameNotBlank() {
        /* given */
        val productCreateRequest = ProductCreateRequest(
            type = ProductType.HANDMADE,
            sellingStatus = ProductSellingType.SELLING,
    ...
    @Test
    fun createProductPriceIsPositive() {
        /* given */
        val productCreateRequest = ProductCreateRequest(
            type = ProductType.HANDMADE,
            sellingStatus = ProductSellingType.SELLING,
